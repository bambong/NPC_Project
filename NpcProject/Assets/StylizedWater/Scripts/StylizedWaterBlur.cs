...
namespace StylizedWaterShader
{
    ...
    public class StylizedWaterBlur : MonoBehaviour
    {
        ...
        readonly int blurredID = Shader.PropertyToID("_BlurBuffer1");
        readonly int blurredID2 = Shader.PropertyToID("_BlurBuffer2");
        readonly int BlurLengthID = Shader.PropertyToID("BlurLength");
        ...
        public void Render()
        {
            ...
            {
                cmd.SetGlobalFloat(BlurLengthID, length / Screen.height);
